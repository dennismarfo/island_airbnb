...
Booking.create!(check_in_date: Date.new(2018,10,3), check_out_date: Date.new(2018,10,10), user_id: User.first.id, property_id: Property.last.id, message:"Nous avons hâte d'arriver ! À bientôt !")
Booking.create!(check_in_date: Date.new(2019,8,12), check_out_date: Date.new(2019,8,19), user_id: User.first.id, property_id: Property.second.id, message:"Nous avons hâte d'arriver ! À bientôt !")
Booking.create!(check_in_date: Date.new(2019,12,20), check_out_date: Date.new(2019,12,30), user_id: User.first.id, property_id: Property.third.id, message:"Nous avons hâte d'arriver ! À bientôt !")
Booking.create!(check_in_date: Date.new(2018,10,3), check_out_date: Date.new(2018,10,10), user_id: User.second.id, property_id: Property.second.id, message:"Nous avons hâte d'arriver ! À bientôt !")
Booking.create!(check_in_date: Date.new(2019,8,12), check_out_date: Date.new(2019,8,19), user_id: User.second.id, property_id: Property.fifth.id, message:"Nous avons hâte d'arriver ! À bientôt !")
Booking.create!(check_in_date: Date.new(2019,12,20), check_out_date: Date.new(2019,12,30), user_id: User.second.id, property_id: Property.fourth.id, message:"Nous avons hâte d'arriver ! À bientôt !")
Booking.create!(check_in_date: Date.new(2018,10,3), check_out_date: Date.new(2018,10,10), user_id: User.third.id, property_id: Property.first.id, message:"Nous avons hâte d'arriver ! À bientôt !")
Booking.create!(check_in_date: Date.new(2019,8,12), check_out_date: Date.new(2019,8,19), user_id: User.third.id, property_id: p6.id, message:"Nous avons hâte d'arriver ! À bientôt !")
Booking.create!(check_in_date: Date.new(2019,12,20), check_out_date: Date.new(2019,12,30), user_id: User.third.id, property_id: p7.id, message:"Nous avons hâte d'arriver ! À bientôt !")
Booking.create!(check_in_date: Date.new(2018,10,3), check_out_date: Date.new(2018,10,10), user_id: User.fourth.id, property_id: Property.second.id, message:"Nous avons hâte d'arriver ! À bientôt !")
Booking.create!(check_in_date: Date.new(2019,8,12), check_out_date: Date.new(2019,8,19), user_id: User.fourth.id, property_id: Property.last.id, message:"Nous avons hâte d'arriver ! À bientôt !")
Booking.create!(check_in_date: Date.new(2019,12,20), check_out_date: Date.new(2019,12,30), user_id: User.fourth.id, property_id: Property.first.id, message:"Nous avons hâte d'arriver ! À bientôt !")
